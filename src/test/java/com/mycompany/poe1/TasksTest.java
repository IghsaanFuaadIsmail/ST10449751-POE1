...
public void testCheckTaskDescription() {
    ...
    Tasks validTask = new Tasks("Login Feature", "Create login to authenticate users", "Robyn Harrison", 8, "To Do");
    ...
    Tasks invalidTask = new Tasks("Add Task Feature", "This is a very long task description that exceeds fifty characters.", "Mike Smith", 10, "Doing");
    ...
    public void testCreateTaskID() {
       // Task 1: "Login Feature" by "Robyn Harrison"
        Tasks task1 = new Tasks("Login Feature", "Create login to authenticate users", "Robyn Harrison", 8, "To Do");
        ...
        Tasks task2 = new Tasks("Add Task Feature", "Create Add Task feature to add users", "Mike Smith", 10, "Doing");
    ...
    public void testReturnTotalHours() {
        ...
        assertEquals(expectedTotalHours, Tasks.returnTotalHours(), "Total task hours should be the sum of all task durations.");
    }
